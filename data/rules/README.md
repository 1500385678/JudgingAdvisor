...
| `risk_flags.json`    | 风险信号规则库  | 手工整理(PUA/NPD/ASPD/煤气灯/三角操纵/情感勒索/受害者扮演/控制型伴侣 8 类) | 20 |
...
> `risk_flags.json` 是 Phase 0 第 5 项基线版(v0.1, 15 条 / 8 类),**2026-09-14 升 v0.2 · 15 → 20 条 · 补 5 类高价值缺口:PUA 甜蜜陷阱(risk_016)/ NPD 镜像投射(risk_017)/ ASPD 责任转嫁(risk_018)/ 煤气灯现实否认(risk_019)/ 控制型伴侣经济控制(risk_020)**;后续 T1 会扩到 50+(v0.5 目标 W2)。
