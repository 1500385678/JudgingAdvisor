...
| `cases.json`         | 案例库          | 手工整理(面试识人/合伙谈判/婚恋首次/团队招聘/重要决策/销售识客 6 场景) | 6 |
...
> `cases.json` 是 Phase 0 第 6 项基线版(v0.1, 5 场景各 1 例);**2026-09-17 升 v0.2 第一步 · 5 → 6 例 · 新增第 6 场景"销售识客" (case_006 · B2B 客户决策人热情买单 + 关键决策权模糊模式) · 6 大场景分布(面试识人/合伙谈判/婚恋首次/团队招聘/重要决策/销售识客)**;后续 T1 会扩到 20-30 条(v0.2 目标 10 例 / W4 · v0.5 目标 20-30 例)。
